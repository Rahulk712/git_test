<?php
/**
 * Template Name: Landing Hindi Page - Home Template
...
// 	$my_query = new WP_Query('post_type=home_template');
	$my_query = new WP_Query('post_type=desktop_landing_hind');
		...
		<div class="container nutrafy_sec">
			<div class="row nutrafy_top">
				...
				<div class="col-md-6 usa">
					<?php /*<img class="tea_cup" src="<?php echo get_site_url(); ?>/wp-content/themes/twentytwenty/assets/images/tea_cup.png">*/?>
			...
			<img class="bg-mod" src="<?php echo get_site_url(); ?>/wp-content/themes/twentytwenty/assets/images/desktopbg.png">
				...
				<div class="col-md-4">
					<div id="order_free" class="nutrify_banner-registration-form_desktop_landing_page">
						...
						<?php /*<img class="offer_money_back" src="<?php echo get_site_url(); ?>/wp-content/themes/twentytwenty/assets/images/money_back.png" alt="Image" >*/?>
							<div class="col-md-12">
							...
							<form id="without_risk" class="no_risk " action="/MasalaTea/shop" method="post">
									<button class="close-btn animate_button">+</button>
								  <h5>बिना किसी जोखिम के प्रयास करें</h5>
								  <input type="text" name="firstname" value="<?php  echo do_shortcode( '[get_user_login]' );?>" placeholder="नाम*" readonly>
								  <br>
								  <div class="email-otp">
								  <input type="text" name="email" value="<?php echo do_shortcode( '[get_user_email]' );?>" placeholder="ईमेल*" readonly>
								  </div>
								  <br>
								  <input type="text" name="phone" value="<?php echo do_shortcode( '[get_user_phone_number]' ); ?>"  placeholder="मोबाइल नंबर*" readonly>
								  <br>	
								  <div class="um-col-alt">		
										<div class="um-center">
											<input type="submit" value="मेरा ऑर्डर जल्दी करें" class="um-button" id="um-submit-btn">
										</div>
									<div class="um-clear"></div>
								</div>
								  <p><span>*</span> * जांच लें कि आपका मोबाइल और आपका ईमेल सही लिखा गया है। यह हमें आपसे संपर्क करने और अपने उत्पाद को भेजने के लिए शिपिंग जानकारी प्राप्त करने की अनुमति देगा।</p>
...
<div class="masala" style="margin-bottom: 179px;">
		<div class="container">
			<div class="row">
				...
				<div class="tall_img">
					<img class="ladygirl_img" src="<?php echo wp_get_attachment_image_url($mypost['banner_image_msn']['0']); ?>" alt=" ">  data-pagespeed-url-hash="1056508746" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
				</div>
			</div>
			</div>
		</div>
...
*/
	?>
	<?php 
	$my_query = new WP_Query('post_type=mobile_landing_hindi');
	    if ( $my_query->have_posts() ) {
		while ( $my_query->have_posts() ) {
		$my_query->the_post();
		$post_id = get_the_ID() ;
...
<div class="container landing_page_mobile">
	...
	<div class="final_mobile_content">
		<p>DISCLAIMER |PRIVACY POLICY | TERMS & CONDITIONS FOR ANY QUESTION EMAIL US: CONTACTMASALA@GMAIL.COM OPEN MONDAY - FRIDAY 9:00 AM TO 6:00 PM IST MASALA FOR SHAPE. \A92020. ALL RIGHTS RESERVED.</p>
	</div>
</div>
