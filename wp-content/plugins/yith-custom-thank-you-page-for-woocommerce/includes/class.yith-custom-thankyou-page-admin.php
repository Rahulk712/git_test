    ...
    class YITH_Custom_Thankyou_Page_Admin  {
        ...
        public function register_panel() {
            ...
            $admin_tabs = apply_filters( 'yith_ctpw_admin_tabs', array(
                    'settings'      => __( 'Settings', 'yith-custom-thank-you-page-for-woocommerce' ),
                )
            );

            if( $this->show_premium_landing ){
                $admin_tabs['premium'] = __( 'Premium Version', 'yith-custom-thank-you-page-for-woocommerce' );
            }
        ...
        public function get_sidebar_link(){
            $links =  array(
                array(
                    'title' => __( 'Plugin documentation', 'yith-custom-thank-you-page-for-woocommerce' ),
                    'url'   => $this->_official_documentation,
                ),
                array(
                    'title' => __( 'Help Center', 'yith-custom-thank-you-page-for-woocommerce' ),
            ...
            if( defined( 'YITH_CTPW_FREE_INIT' ) ){
                $links[] = array(
                    'title' => __( 'Discover the premium version', 'yith-custom-thank-you-page-for-woocommerce' ),
                    'url'   => $this->_premium_landing,
                );

                $links[] = array(
                    'title' => __( 'Free vs Premium', 'yith-custom-thank-you-page-for-woocommerce' ),
                    'url'   => 'https://yithemes.com/themes/plugins/yith-custom-thank-you-page-for-woocommerce/#tab-free_vs_premium_tab',
                );

                $links[] = array(
                    'title' => __( 'Premium live demo', 'yith-custom-thank-you-page-for-woocommerce' ),
                    'url'   => $this->_premium_live
                );

                $links[] =  array(
                    'title' => __( 'WordPress support forum', 'yith-custom-thank-you-page-for-woocommerce' ),
                    'url'   => 'https://wordpress.org/plugins/yith-custom-thank-you-page-for-woocommerce/',
                );

                $links[] =  array(
                    'title' => sprintf( '%s (%s %s)', __( 'Changelog', 'yith-custom-thank-you-page-for-woocommerce' ), __( 'current version','yith-custom-thank-you-page-for-woocommerce' ), YITH_CTPW_VERSION ),
            ...
            if( defined( 'YITH_CTPW_PREMIUM' ) ){
                $links[] =  array(
                    'title' => __( 'Support platform', 'yith-custom-thank-you-page-for-woocommerce' ),
