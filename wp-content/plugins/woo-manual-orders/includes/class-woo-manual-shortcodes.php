...
class Woo_Manual_Order_Shortcodes {
	...
	public static function load_scripts(){
		...
		wp_register_script( 'woo-manual-order-checkout', $woo_manual_order->plugins_url( 'assets/js/manual-order-checkout.js' ), array('manual-order-select', 'wc-cart', 'wc-checkout'),'5.3.3' );
